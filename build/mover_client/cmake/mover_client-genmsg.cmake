...
set(MSG_I_FLAGS "-Imover_client:/home/user/sudoku_bot_ws/src/mover_client/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/user/sudoku_bot_ws/src/mover_client/msg/grid_num_vector.msg" NAME_WE)
add_custom_target(_mover_client_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mover_client" "/home/user/sudoku_bot_ws/src/mover_client/msg/grid_num_vector.msg" "mover_client/grid_num"
)

get_filename_component(_filename "/home/user/sudoku_bot_ws/src/mover_client/msg/grid_num.msg" NAME_WE)
add_custom_target(_mover_client_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mover_client" "/home/user/sudoku_bot_ws/src/mover_client/msg/grid_num.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mover_client)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mover_client\")")
  # install generated code
  install(
